...
public native_load_setting_string_arr(plugin_id, num_params)
{
	...
	{
		zp_core_log_error("Can't load settings: empty filename")
		return false;
	}
	...
	{
		zp_core_log_error("Can't load settings: empty section/key")
		return false;
	}
	...
	{
		zp_core_log_error("Array not initialized")
		return false;
	}
...
public native_save_setting_string_arr(plugin_id, num_params)
{
	...
	if (strlen(filename) < 1)
	{
		zp_core_log_error("Can't save settings: empty filename")
		return false;
	}
	...
	if (strlen(setting_section) < 1 || strlen(setting_key) < 1)
	{
		zp_core_log_error("Can't save settings: empty section/key")
		return false;
	}
